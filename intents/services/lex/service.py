"""
Here we implement :class:`LexPredictionService`, the instance of
:class:`PredictionService` that allows Agents to operate on AWS LEX

NOTE: LEX support is **experimental**

- no Sys.Any
- parameters MUST define prompts
"""
...
# @dataclass
# class LexPrediction(Prediction):
#     """
